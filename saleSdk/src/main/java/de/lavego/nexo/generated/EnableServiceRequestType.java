...
/**
 * Definition: Content of the Enable Service Request message. -- Usage:
 * 				It conveys the services that will be enabled for the POI Terminal without the
 * 				request of the Sale System, and a possible invitation for the Customer to start the
 * 				services.
 *
 * <p>Java-Klasse für EnableServiceRequestType complex type.
 *
...
public class EnableServiceRequestType {
    ...
    /**
     * Ruft den Wert der transactionAction-Eigenschaft ab.
     *
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Legt den Wert der transactionAction-Eigenschaft fest.
     *
     * @param value
     *     allowed object is
     *     {@link String }
