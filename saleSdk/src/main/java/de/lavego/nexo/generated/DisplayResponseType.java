...
/**
 * Definition: Content of the Display Response message. -- Usage: It
 * 				conveys the result of the display, parallel to the message request, except if
 * 				response not required and absent.
 *
 * <p>Java-Klasse für DisplayResponseType complex type.
 *
...
public class DisplayResponseType {
    @Element(name = "OutputResult", required = true)
